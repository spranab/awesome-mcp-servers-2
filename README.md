...
- 🧠 [YantrikDB MCP](https://github.com/yantrikos/yantrikdb-mcp) - Cognitive memory for AI agents — persistent semantic memory with knowledge graph, adaptive recall, conflict detection, and entity relationships across sessions. Works with Claude Code, Cursor, Windsurf, and any MCP client.
<br />
