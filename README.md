...
- 📋 [Saga](https://github.com/spranab/saga-mcp) - Jira-like project tracking (epics, stories, tasks) for AI agents that lives inside the agent loop — SQLite-backed, 22 tools, with a local dashboard.
